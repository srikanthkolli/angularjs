...
if($id!=""){
	...
	if($DeleteRes){
		header("Location:delete_file.php?msg=3");
		exit;
	}
}
?>
...
<table style="color:black;border:1px solid white;">
	...
	<input type="button" value="Add Record" onclick="location.href='registration.php'">
	<?php
		$variable="select * from form_reg";
	...
	<tr bgcolor="<?php echo $bgcolor; ?>">
		...
		<td width="10%"><a href="registration.php?id=<?php echo $id;?>">Edit</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="delete_file.php?id=<?php echo $id;?>" onclick="return confirm('Are you sure want to delete this Record?')">Delete</a></td>
		</tr>
		<?php
			$i++;
			}
