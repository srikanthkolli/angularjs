  ...
  <form method="POST" action="" id="form">
	<div class="header">
		...
		<div class="header3">
			...
			<div class="header5">
				<!-- <input type="button" value="Logout" style="height:40px;background-color:#3399FF;" onclick="document.location='logout.php'"> -->
				<a HREF="logout.php" style="height:40px;background-color:#3399FF;">Logout</a>
			</div>
			</div>
		</div>
		<div class="con" style="background-color:#ECEFF1;">
			<div class="con1">
		...
		<div style="float:left;margin-left:310px;font-size:medium;margin-top:200px;font-family:SWANSE__;">Welcome to admin control panel
		</div>
		<div class="footer">
